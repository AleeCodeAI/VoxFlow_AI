...
class Verifier:
    ...
    def __init__(self):
        ...
        self.db_path = os.path.join(BASE_DIR, "..", "..", "..", "..", "databases", "preprocessings.jsonl")
...
if __name__ == "__main__":
    verifier = Verifier()
    print("=="*15)
    print(verifier.verify_output_file("e6288c87-afeb-4260-9f08-f7eae9ed3e7d"))  # Replace with actual ID to test